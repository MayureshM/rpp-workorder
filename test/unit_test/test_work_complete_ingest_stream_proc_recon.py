...
event_file = f"{CURRENT_DIR}/test_data_files/request/work_complete_ingest_stream_proc_recon.json"
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/work_complete_ingest_stream_proc_recon.json"
...
def test_work_complete_ingest_stream_proc_recon_complete(
    ...
    if dynamodb_response["Items"][0].get("recon_complete") and \
