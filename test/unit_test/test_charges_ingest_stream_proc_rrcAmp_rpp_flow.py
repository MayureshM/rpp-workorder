...
event_file = (
    f"{CURRENT_DIR}/test_data_files/request/charges_ingest_stream_proc_rrcAmp_rpp_flow.json"
)
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/charges_ingest_stream_proc_rrcAmp_rpp_flow.json"
...
def test_charges_ingest_rrc_amp_rpp_flow(
