...
event_file = (
    f"{CURRENT_DIR}/test_data_files/request/charges_ingest_stream_proc_amp_dealer_pick_up.json"
)
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/charges_ingest_stream_proc_amp_dealer_pick_up.json"
fee_name = "charge:dealer_pickup_fee#"
...
def test_charges_ingest_stream_proc_amp_dealer_pick_up(
