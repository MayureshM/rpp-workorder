...
event_file = (
    f"{CURRENT_DIR}/test_data_files/request/charges_ingest_stream_proc_cmov_wash_vac.json"
)
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/charges_ingest_stream_proc_cmov_wash_vac.json"
fee_name = "charge:wash_and_vac_fee#"
...
def test_charges_ingest_stream_proc_cmov_wash_vac(
