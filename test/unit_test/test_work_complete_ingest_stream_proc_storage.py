...
event_file = f"{CURRENT_DIR}/test_data_files/request/work_complete_ingest_stream_proc_storage.json"
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/work_complete_ingest_stream_proc_storage.json"
...
def test_work_complete_ingest_stream_proc_storage_complete(
    ...
    if dynamodb_response["Items"][0].get("storage_complete") and \
