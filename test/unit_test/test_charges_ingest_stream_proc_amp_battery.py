...
event_file = (
    f"{CURRENT_DIR}/test_data_files/request/charges_ingest_stream_proc_amp_battery.json"
)
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/charges_ingest_stream_proc_amp_battery.json"
fee_name = "charge:vehicle_charging_fee#"
...
def test_charges_ingest_stream_proc_amp_battery(
