...
event_file = f"{CURRENT_DIR}/test_data_files/request/work_complete_ingest_stream_proc_amp.json"
exp_response_file = f"{CURRENT_DIR}/test_data_files/expected_response/work_complete_ingest_stream_proc_amp.json"
...
def test_work_complete_ingest_stream_proc_amp(
